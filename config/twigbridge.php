 ...
 */
//$CookieGuest = (empty($_COOKIE['guest']) ? null : json_decode($_COOKIE['guest']) );
...
return [
    ...
    'twig' => [
        ...
        */
        ...
        |
        */
        'globals' => [  'APP_NAME'  => env('APP_NAME', 'Inforce Website'),
                        'APP_DEBUG' => env('APP_DEBUG'),                        
                        'IMG_PATH'  => env('IMG_PATH'),
                        'API_PATH'  => env('API_PATH'),
                        'ADMIN_PATH'  => env('ADMIN_PATH'),
                        'API_KEY'   => env('API_KEY'),
                        'G_IP'      => (empty($_SERVER['REMOTE_ADDR']) ? '127.0.0.1' : $_SERVER['REMOTE_ADDR'] ),
                        'G_PROX_IP' => (empty($_SERVER['HTTP_X_FORWARDED_FOR']) ? '127.0.0.1' : $_SERVER['HTTP_X_FORWARDED_FOR'] ),
                        'LC_IP'     => '127.0.0.1',
                        'DBG_IP'    => '177.129.9.98',            
            ],
    ],
